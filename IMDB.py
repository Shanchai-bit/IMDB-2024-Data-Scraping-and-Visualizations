    ...
    if 'Genre' in df.columns:
        ...
        with col2:
            with st.expander("Insights:"):
                st.write("1. **Drama is the most:** There are way more drama movies than any other type listed.")
                st.write("2. **Comedy is second:** Comedy is the next most common type of movie.")
        ...
        with st.expander("Insights"):
            ...
            st.write("2. **Comedy is also popular:** Comedy movies are the second most common.")
...
with tab4:
    ...
    if 'Votes' in df.columns:
        ...
        with st.expander("Insights:"):
            ...
            st.write("3. **Drama, Family similar:** Drama and Family genres have comparable vote counts.")
